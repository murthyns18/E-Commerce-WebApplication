...
public class FansMessage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Message to Murthy Electronics</h2>" + ""
				...
				+ "</body>" + "</html>";
		String message = MailMessage.sendMessage("murthy.ns@gmail.com", "Fans Message | " + name + " | " + email,
				htmlTextMessage);
